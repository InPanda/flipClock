...
<style>
  @import url("./../../public/dsDigital/DS-DIGIB.css");
    .M-Flipper {
    ...
    .M-Flipper.down.go .front:before {
        ...
        animation: frontFlipDown 2.6s ease-in-out both;
        box-shadow: 0 -2px 6px rgba(255, 255, 255, 0.3);
        backface-visibility: hidden;
    }

    .M-Flipper.down.go .back:after {
        animation: backFlipDown 2.6s ease-in-out both;
    }
    ...
    .M-Flipper.up.go .front:after {
        transform-origin: 50% 0;
        animation: frontFlipUp 2.6s ease-in-out both;
        /* box-shadow: 0 2px 6px rgba(255, 255, 255, 0.3); */
        backface-visibility: hidden;
    }

    .M-Flipper.up.go .back:before {
        animation: backFlipUp 2.6s ease-in-out both;
    }
